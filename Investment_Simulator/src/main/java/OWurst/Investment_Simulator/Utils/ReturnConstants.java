...
public class ReturnConstants {
    public static ReturnDTO badSession() {
        return new ReturnBuilder().withErrorMsg("Error: Session could not be found.").withRespCode(400).build();
    }

    public static ReturnDTO handled400Error(String msg) {
        return new ReturnBuilder().withErrorMsg(msg).withRespCode(400).build();
    }

    public static ReturnDTO unverifiedSession() {
        return new ReturnBuilder().withErrorMsg("Error: Session could not be verified.").withRespCode(400).build();
    }

    public static ReturnDTO unknownError(String msg) {
        return new ReturnBuilder().withErrorMsg(msg).withRespCode(500).build();
    }
